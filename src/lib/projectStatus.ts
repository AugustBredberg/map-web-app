...
export const STATUS_ICON_PATHS: Record<number, string> = {
  ...
  2: "M5.25 5.653c0-.856.917-1.398 1.667-.986l11.54 6.347a1.125 1.125 0 0 1 0 1.972l-11.54 6.347a1.125 1.125 0 0 1-1.667-.986V5.653z",
  3: "M12 6v6h4.5m4.5 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0z",
  4: "M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0z",
  5: "M3 3v1.5M3 21v-6m0 0 2.77-.693a9 9 0 0 1 6.208.682l.108.054a9 9 0 0 0 6.086.71l3.114-.732a48.524 48.524 0 0 1-.005-10.499l-3.11.732a9 9 0 0 1-6.085-.711l-.108-.054a9 9 0 0 0-6.208-.682L3 4.5M3 15V4.5",
  6: "M9.75 9.75l4.5 4.5m0-4.5-4.5 4.5M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0z",
};
 ...
 * States with no entry (Done=5) have no outgoing transitions.
 */
export const STATUS_TRANSITIONS: Partial<Record<ProjectStatus, StatusTransition[]>> = {
  0: [
    ...
    { to: 2, labelKey: "markReady",          primary: true,  color: "primary"  },
  ],
  1: [
    { to: 2, labelKey: "markReady",          primary: true,  color: "primary"  },
  ],
  2: [
    { to: 3, labelKey: "startWork",          primary: true,  color: "primary"  },
  ],
  3: [
    { to: 5, labelKey: "completeJob",        primary: true,  color: "success"  },
    { to: 4, labelKey: "reportBlockage",     primary: false, color: "warning"  },
  ],
  4: [
    { to: 3, labelKey: "resumeWork",         primary: true,  color: "primary"  },
  ],
  5: [],
  6: [
